...
const rocketIcon = <svg xmlns="http://www.w3.org/2000/svg" width="45%" height="45%" fill="currentColor"
...
const cartIcon = <svg xmlns="http://www.w3.org/2000/svg" width="45%" height="45%" fill="currentColor"
                        className="bi bi-cart3" viewBox="0 0 16 16">
    <path
        d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
</svg>

const stockIcon = <svg xmlns="http://www.w3.org/2000/svg" width="45%" height="45%" fill="currentColor"
...
const clientsIcon =  <svg xmlns="http://www.w3.org/2000/svg" width="45%" height="45%" fill="currentColor"
                          className="bi bi-people-fill" viewBox="0 0 16 16">
    <path
        d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7Zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216ZM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z"/>
</svg>

const androidIcon =  <svg xmlns="http://www.w3.org/2000/svg" width="45%" height="45%" fill="currentColor"
...
const reportsIcon =  <svg xmlns="http://www.w3.org/2000/svg" width="45%" height="45%" fill="currentColor"
                         className="bi bi-bar-chart-fill" viewBox="0 0 16 16">
    <path
        d="M1 11a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-3zm5-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V7zm5-5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1V2z"/>
</svg>

const settingsIcon =  <svg xmlns="http://www.w3.org/2000/svg" width="45%" height="45%" fill="currentColor"
...
const goBackIcon = <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
